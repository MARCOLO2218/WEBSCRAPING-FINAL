@echo off
setlocal
title Crear acceso directo - Catalogo FACENCO DEV

set "SERVIDOR=http://172.16.247.6:3030/"
set "NOMBRE=Catalogo Comercial FACENCO DEV.url"
...
if exist "%ESCRITORIO%\Catalogo Comercial FACENCO DEV.lnk" del /F /Q "%ESCRITORIO%\Catalogo Comercial FACENCO DEV.lnk"
...
echo.
echo Acceso directo DEV creado correctamente.
