...
| `SPEC-050-siman-nicaragua.md` | Corrección local; piloto DEV pendiente | Descuento unido al precio causó descartes; normalizador ajustado y requiere revalidación. |
